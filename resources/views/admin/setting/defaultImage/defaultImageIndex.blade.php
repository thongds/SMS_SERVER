                        ...
                        <table class="table table-hover">
                            ...
                            if($listData){
                                ...
                                foreach ($listData as $list){
                                    ...
                                    echo '<td><img width="100" height="100" src="'.$list['content'].'"></td>';
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Avatar Default</label>
                        <input type="file" name ="avatar" class="form-control" id="exampleInputEmail1" >
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Logo Image default</label>
                        <input type="file" name ="logo" class="form-control" id="exampleInputEmail1" >
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Content Image Default</label>
                        <input type="file" name ="content" class="form-control" id="exampleInputEmail1" >
                    </div>
                    <div class="checkbox">
                        <label>
