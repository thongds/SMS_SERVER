            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        @if(!$isEdit)
                            <input type="input" name ="type" class="form-control" id="exampleInputEmail1" placeholder="Enter Role Type">
                        @else
                            <input type="input" name ="type" value = "<?php echo $update_data["type"]; ?>" class="form-control" id="exampleInputEmail1" >
                        @endif
                    </div>
                    <div class="checkbox">
                        <label>
