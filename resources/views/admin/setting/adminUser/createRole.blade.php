    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <?php echo Form::open(array('route'=>'createRole','method'=>'post','enctype'=>'multipart/form-data')) ?>
                {{--<form role="form">--}}
                <div class="box-header with-border">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Role type number</label>
                            <input type="input" name = "role_type" class="form-control" id="exampleInputPassword1" placeholder="Role type number">
                        </div>
